...
// FunÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½o para calcular HP baseado no nÃƒÂ¯Ã‚Â¿Ã‚Â½vel e tipo de PokÃƒÆ’Ã‚Â©mon
...
export const starterPokemon: Record<string, Pokemon> = {
  ...
  Eevee: { HP: 40, maxHP: 40, attacks: { Investida: [8, 15], "Ataque RÃƒÆ’Ã‚Â¡pido": [12, 25] }, level: 5, xp: 0, sprite: "https://play.pokemonshowdown.com/sprites/ani/eevee.gif",
    type: "Normal",
    speed: 55,
  },
}
...
> = {
  ...
  Ekans: {
    ...
    type: "Veneno",
    baseHP: 32,
    attacks: { Picada: [10, 18], "Ãcido": [12, 20] },
    rarity: "comum",
    speed: 55,
  },
  Pikachu: {
    ...
    type: "Elétrico",
    baseHP: 30,
    attacks: { "Choque do Trovão": [12, 22], "Ataque RÃƒÆ’Ã‚Â¡pido": [10, 18] },
    rarity: "raro",
    speed: 90,
  },
  Sandshrew: {
  ...
  Jigglypuff: {
    ...
    type: "Normal/Fada",
    baseHP: 80,
    attacks: { Tapa: [8, 15], "CanÃ§Ã£o": [0, 0] },
    rarity: "raro",
    speed: 20,
  },
  Zubat: {
    ...
    type: "Veneno/Voador",
    baseHP: 30,
    attacks: { Mordida: [10, 18], "SupersÃ´nico": [8, 15] },
    rarity: "comum",
    speed: 55,
  },
  Oddish: {
    ...
    type: "Grama/Veneno",
    baseHP: 38,
    attacks: { Absorver: [10, 18], "PÃƒÆ’Ã‚Â³ Venenoso": [8, 15] },
    rarity: "comum",
    speed: 30,
  },
  Paras: {
  ...
  Mankey: {
    ...
    type: "Lutador",
    baseHP: 35,
    attacks: { "Arranhão": [10, 18], "Soco KaratÃª": [15, 28] },
    rarity: "comum",
    speed: 70,
  },
  Growlithe: {
  ...
  Abra: { sprite: "https://play.pokemonshowdown.com/sprites/ani/abra.gif", type: "Psíquico", baseHP: 20, attacks: { Teletransporte: [0, 0] }, rarity: "raro", speed: 90 },
  Machop: {
    sprite: "https://play.pokemonshowdown.com/sprites/ani/machop.gif",
    type: "Lutador",
    baseHP: 50,
    attacks: { "Soco KaratÃª": [15, 28], "Golpe Baixo": [12, 22] },
    rarity: "comum",
    speed: 35,
  },
  Bellsprout: {
    ...
    type: "Grama/Veneno",
    baseHP: 40,
    attacks: { "Chicote de Vinha": [12, 22], "Ãcido": [10, 18] },
    rarity: "comum",
    speed: 40,
  },
  Tentacool: {
  ...
  Magnemite: {
    ...
    type: "Elétrico/AÃ§o",
    baseHP: 28,
    attacks: { "Choque do Trovão": [12, 22], "SupersÃ´nico": [8, 15] },
    rarity: "raro",
    speed: 45,
  },
  Doduo: {
  ...
  Grimer: {
    ...
    type: "Veneno",
    baseHP: 55,
    attacks: { "Bola de Lama": [12, 22], "Ãcido": [15, 28] },
    rarity: "comum",
    speed: 25,
  },
  Shellder: {
  ...
  Voltorb: {
    ...
    type: "Elétrico",
    baseHP: 35,
    attacks: { "Choque do Trovão": [12, 22], "AutodestruiÃ§Ã£o": [40, 60] },
    rarity: "comum",
    speed: 100,
  },
  Exeggcute: {
  ...
  Hitmonlee: {
    ...
    type: "Lutador",
    baseHP: 42,
    attacks: { "Chute Alto": [20, 38], "Chute GiratÃ³rio": [25, 45] },
    rarity: "raro",
    speed: 87,
  },
  Hitmonchan: {
  ...
  Koffing: {
    ...
    type: "Veneno",
    baseHP: 35,
    attacks: { "Bola de Lama": [12, 22], "AutodestruiÃ§Ã£o": [40, 60] },
    rarity: "comum",
    speed: 35,
  },
  Rhyhorn: {
...
// Apply canonical type data to every wild PokÃ©mon entry so manually authored
...
// (e.g. showing a PokÃ©mon as "Normal" when canonical data says otherwise).
Object.keys(wildPokemon).forEach((name) => {
  try {
    const typeOverride = (generatedWildTypes as Record<string, string>)[name]
    if (typeOverride) {
...
// Adiciona um conjunto de Ultra Beasts ao pool de pokÃ©mons selvagens e registra sprites
const ultraBeasts: Record<string, any> = {
  ...
  Celesteela: { sprite: "https://play.pokemonshowdown.com/sprites/ani/celesteela.gif", type: "AÃ§o/Voador", baseHP: 97, attacks: { "Lança MetÃ¡lica": [26, 46], "Raio de Gelo": [20, 38] }, rarity: "lendario", speed: 55 },
  Kartana: { sprite: "https://play.pokemonshowdown.com/sprites/ani/kartana.gif", type: "Grama/AÃ§o", baseHP: 59, attacks: { "Corte": [32, 54], "Golpe de LÃ¢mina": [30, 52] }, rarity: "lendario", speed: 109 },
  Guzzlord: { sprite: "https://play.pokemonshowdown.com/sprites/ani/guzzlord.gif", type: "Sombrio/Dragão", baseHP: 120, attacks: { "DevoraÃ§Ã£o": [36, 68], "Mordida": [26, 50] }, rarity: "lendario", speed: 38 },
  ...
  Stakataka: { sprite: "https://play.pokemonshowdown.com/sprites/ani/stakataka.gif", type: "Pedra/AÃ§o", baseHP: 123, attacks: { "Arremesso de Pedras": [36, 68], "Escudo": [0, 0] }, rarity: "lendario", speed: 28 },
  Blacephalon: { sprite: "https://play.pokemonshowdown.com/sprites/ani/blacephalon.gif", type: "Fogo/Fantasma", baseHP: 73, attacks: { "ExplosÃ£o de CabeÃ§a": [36, 70], "Bola Sombria": [26, 50] }, rarity: "lendario", speed: 97 },
}

Object.assign(wildPokemon as any, ultraBeasts as any)

// Registrar sprites no catÃ¡logo para manter consistÃªncia com starters
...
const speciesLevelUpMoves: Record<string, LevelUpMove[]> = {
  ...
  Bulbasaur: [
    ...
    { level: 13, name: "PÃ³ Venenoso", power: [0, 0] },
  ...
  Zubat: [
    { level: 9, name: "SupersÃ´nico", power: [0, 0] },
...
const manualEvolutionRules: Record<string, EvolutionRule> = {
  ...
  Teddiursa: { level: 30, evolvesTo: "Ursaring" },
...
const moveStatusEffects: Record<string, MoveStatusEffect> = {
  ...
  canÃ§Ã£o: { status: "asleep", chance: 0.85, turns: [1, 3] },
  ...
  supersÃ´nico: { status: "confused", chance: 1, turns: [2, 4] },
}
...
export const pokeballs: Record<string, { chance: number; price: number; color: string }> = {
  "PokÃ©bola": { chance: 0.3, price: 10, color: "from-red-500 to-red-600" },
...
export const typeColors: Record<string, string> = {
  ...
  "AÃ§o": "from-gray-500 to-slate-600",
...
export const typeChart: Record<string, Record<string, number>> = {
  ...
  Voador: { Lutador: 2, Pedra: 0.5, Inseto: 2, "AÃ§o": 0.5, Grama: 2, "Elétrico": 0.5 },
  Veneno: { Veneno: 0.5, Terra: 0.5, Pedra: 0.5, Fantasma: 0.5, "AÃ§o": 0, Grama: 2, Fada: 2 },
  Terra: { Voador: 0, Veneno: 2, Pedra: 2, Inseto: 0.5, "AÃ§o": 2, Fogo: 2, Grama: 0.5, "Elétrico": 2 },
  Pedra: { Lutador: 0.5, Voador: 2, Terra: 0.5, Inseto: 2, "AÃ§o": 0.5, Fogo: 2, Gelo: 2 },
  Inseto: { Lutador: 0.5, Voador: 0.5, Veneno: 0.5, Fantasma: 0.5, "AÃ§o": 0.5, Fogo: 0.5, Grama: 2, "Psíquico": 2, Sombrio: 2, Fada: 0.5 },
  Fantasma: { Normal: 0, Fantasma: 2, "Psíquico": 2, Sombrio: 0.5 },
  "AÃ§o": { Pedra: 2, "AÃ§o": 0.5, Fogo: 0.5, Água: 0.5, "Elétrico": 0.5, Gelo: 2, Fada: 2 },
  Fogo: { Pedra: 0.5, Inseto: 2, "AÃ§o": 2, Fogo: 0.5, Água: 0.5, Grama: 2, Gelo: 2, Dragão: 0.5 },
  Água: { Terra: 2, Pedra: 2, Fogo: 2, Água: 0.5, Grama: 0.5, Dragão: 0.5 },
  Grama: { Voador: 0.5, Veneno: 0.5, Terra: 2, Pedra: 2, Inseto: 0.5, "AÃ§o": 0.5, Fogo: 0.5, Água: 2, Grama: 0.5, Dragão: 0.5 },
  "Elétrico": { Voador: 2, Terra: 0, Água: 2, Grama: 0.5, "Elétrico": 0.5, Dragão: 0.5 },
  "Psíquico": { Lutador: 2, Veneno: 2, "AÃ§o": 0.5, "Psíquico": 0.5, Sombrio: 0 },
  Gelo: { Voador: 2, Terra: 2, "AÃ§o": 0.5, Fogo: 0.5, Água: 0.5, Grama: 2, Gelo: 0.5, Dragão: 2 },
  Dragão: { "AÃ§o": 0.5, Dragão: 2, Fada: 0 },
  Sombrio: { Lutador: 0.5, Fantasma: 2, "Psíquico": 2, Sombrio: 0.5, Fada: 0.5 },
  Fada: { Lutador: 2, Veneno: 0.5, "AÃ§o": 0.5, Fogo: 0.5, Dragão: 2, Sombrio: 2 },
}
...
// FunÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½o para selecionar PokÃƒÆ’Ã‚Â©mon selvagem baseado na raridade e progresso do jogo
